...
export interface AIRequest {
  type: 'clinical_note' | 'clinical_note_with_emr_data' | 'auto_generate_from_emr_only' | 'diagnosis_support' | 'medical_coding' | 'medication_check' | 'care_plan' | 'claims_review' | 'triage_assessment' | 'note_suggestions';
  data: any;
  context?: string;
}
