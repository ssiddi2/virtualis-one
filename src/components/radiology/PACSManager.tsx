  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white brand-font gradient-text">PACS & Radiology Workflow</h1>
          <p className="text-white/60 tech-font">Picture Archiving and Communication System - Smart Radiology Platform</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        ...
        <Card className="glass-card">
          <CardHeader className="pb-2">
            <CardTitle className="text-virtualis-gold text-sm font-medium tech-font">Storage Used</CardTitle>
          </CardHeader>
          <CardContent>
      ...
      <Tabs defaultValue="worklist" className="space-y-4">
        <TabsList className="glass-nav-item bg-black/20">
          <TabsTrigger value="worklist" className="text-white data-[state=active]:text-virtualis-gold">Radiology Worklist</TabsTrigger>
          <TabsTrigger value="viewer" className="text-white data-[state=active]:text-virtualis-gold">DICOM Viewer</TabsTrigger>
          <TabsTrigger value="reporting" className="text-white data-[state=active]:text-virtualis-gold">Reporting Suite</TabsTrigger>
          <TabsTrigger value="archive" className="text-white data-[state=active]:text-virtualis-gold">Archive Management</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="worklist" className="space-y-4">
          <Card className="glass-card">
            <CardHeader>
              <div className="flex items-center justify-between">
                <div>
                  <CardTitle className="text-white tech-font">Radiology Worklist</CardTitle>
                  <CardDescription className="text-white/60">Priority-based imaging study interpretation queue</CardDescription>
                </div>
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-white/10">
                    ...
                    <TableHead className="text-virtualis-gold tech-font">Study Date</TableHead>
                    ...
                    <TableHead className="text-virtualis-gold tech-font">Body Part</TableHead>
                    <TableHead className="text-virtualis-gold tech-font">Images</TableHead>
                    ...
                    <TableHead className="text-virtualis-gold tech-font">Radiologist</TableHead>
        ...
        <TabsContent value="viewer" className="space-y-4">
          <Card className="glass-card">
            <CardHeader>
              <CardTitle className="text-white tech-font">Advanced DICOM Viewer</CardTitle>
              <CardDescription className="text-white/60">Multi-planar reconstruction and advanced visualization tools</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12">
                <Monitor className="h-12 w-12 text-virtualis-gold mx-auto mb-4" />
                <h3 className="text-lg font-semibold text-white mb-2">Smart Radiology Viewer</h3>
                <p className="text-white/60 mb-4">AI-enhanced imaging with advanced post-processing capabilities</p>
                <Button className="glass-button">Launch Viewer</Button>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="reporting" className="space-y-4">
          <Card className="glass-card">
            <CardHeader>
              <CardTitle className="text-white tech-font">Radiology Reporting Suite</CardTitle>
              <CardDescription className="text-white/60">Structured reporting with voice recognition and templates</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12">
                <FileImage className="h-12 w-12 text-virtualis-gold mx-auto mb-4" />
                <h3 className="text-lg font-semibold text-white mb-2">Intelligent Reporting Platform</h3>
                <p className="text-white/60 mb-4">Voice-to-text, structured templates, and AI-assisted reporting</p>
                <Button className="glass-button">Open Report Builder</Button>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="archive" className="space-y-4">
          <Card className="glass-card">
            <CardHeader>
              <CardTitle className="text-white tech-font">Archive & Storage Management</CardTitle>
              <CardDescription className="text-white/60">DICOM storage, lifecycle management, and data migration</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="text-center py-12">
                <ImageIcon className="h-12 w-12 text-virtualis-gold mx-auto mb-4" />
                <h3 className="text-lg font-semibold text-white mb-2">Enterprise Archive System</h3>
                <p className="text-white/60 mb-4">Scalable storage with automated lifecycle policies and cloud integration</p>
                <Button className="glass-button">Manage Archive</Button>
              </div>
            </CardContent>
          </Card>
        </TabsContent>
