              ...
              <div>
                ...
                <div className="space-y-1">
                  {currentImage.aiAnalysis.abnormalities.map((abnormality, index) => (
                    <Badge key={index} className="bg-orange-600/20 text-orange-300 mr-1">
          ...
          <CardContent>
            <div className="space-y-3">
              <div>
                ...
                <p className="text-slate-300 text-sm">{currentImage.findings}</p>
              </div>
              ...
              {currentOrder && (
                <>
                  <div>
                    ...
                    <p className="text-slate-300 text-sm">{currentOrder.impression || 'Pending radiologist review'}</p>
                  </div>
                  
                  <div>
                    <h4 className="text-white font-medium mb-1">Recommendations</h4>
                    <p className="text-slate-300 text-sm">{currentOrder.recommendations || 'To be determined'}</p>
                  </div>
                </>
              )}
            </div>
