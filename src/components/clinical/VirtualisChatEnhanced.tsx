        ...
        <div className="mb-8">
          <div className="flex items-center justify-center gap-3 mb-6">
            <div className="p-3 backdrop-blur-sm bg-blue-600/30 rounded-xl border border-blue-400/30">
              <Brain className="h-8 w-8 text-sky-300 animate-pulse" />
            </div>
            <div className="text-center">
              ...
              <p className="text-white/80 text-lg">
                AI-Powered Clinical Communication Platform
              </p>
            </div>
          </div>
            ...
            {['all', 'critical', 'urgent', 'mine'].map((filter) => (
              <Button
                ...
                className={activeFilter === filter 
                  ...
                  : "backdrop-blur-xl bg-blue-500/20 border border-blue-300/30 text-white hover:bg-blue-500/30"
                }
              >
                ...
                {filteredMessages.map((message) => (
                  ...
                  >
                    ...
                    <div className="flex gap-2 mt-3">
                      ...
                      <Button size="sm" className="backdrop-blur-xl bg-blue-500/20 border border-blue-300/30 text-white hover:bg-blue-500/30">
          ...
          <div className="space-y-6">
            ...
            <Card className="backdrop-blur-xl bg-blue-500/20 border border-blue-300/30 rounded-xl shadow-lg">
              ...
              <CardContent className="space-y-3">
                <Button className="w-full backdrop-blur-xl bg-blue-500/20 border border-blue-300/30 text-white hover:bg-blue-500/30 justify-start">
