...
const EMRDashboard = ({ hospitalId, user, onSelectHospital }: EMRDashboardProps) => {
  ...
  return (
    <>
              ...
              <Card key={hospital.id} className="backdrop-blur-xl bg-blue-500/20 border border-blue-300/30 rounded-xl shadow-lg hover:scale-[1.02] transition-all">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex gap-2 pt-2">
                    ...
                    >
                      {isConnecting && connectingHospital?.id === hospital.id ? 'Connecting...' : 'Enter Hospital System'}
                    </Button>
                    <Button 
                      variant="outline" 
      ...
      {/* EMR Connection Dialog */}
      <EMRConnectionDialog
        isOpen={isConnecting}
        hospitalName={connectingHospital?.name || ''}
        emrType={connectingHospital?.emr_type || ''}
